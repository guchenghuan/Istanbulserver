...
function createHandler(opts) {
    ...
    app.get('/', function (req, res) {
        ...
        var testfilename = req.query.name;  //  请求带参，查询数据 
        if (origUrl.charAt(origLength - 1) !== '/') {
            origUrl += '/';
        }
        core.render(null, res, origUrl, testfilename);
    });
    ...
    app.get('/show', function (req, res) {
        ...
        // console.log('res: ', res)
        core.render(file, res, origUrl, null);
    });
    ...
    app.post('/client', function (req, res) {
        // console.log('req: ', req)
        var filename = req.query.file;  //  p的参数值
        var body = req.body;
        ...
        core.mergeClientCoverage(body, filename);
